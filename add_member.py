...
try:
    ...
    while i < total_user:
        ...
        # count_add if added 10 user
        if count_add % (10 * total_client) == (10 * total_client - 1):
        ...
        try:
            ...
            # print('sleep: ' + 180)
            # time.sleep(180)
            print('sleep: ' + str(5000 / total_client) + ', finished users : ' + str(i))
            time.sleep(5000 / total_client)
